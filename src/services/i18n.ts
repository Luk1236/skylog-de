...
export const TEXTE = {
  ...
  'planer.modusRoute': { de: 'Route', en: 'Route' },
  'planer.modusFlaeche': { de: 'Fläche', en: 'Area' },
  'planer.hinweisFlaeche': { de: 'Zwei gegenüberliegende Ecken tippen — daraus wird eine Mäander-Route für Kartierungsflüge.', en: 'Tap two opposite corners — this builds a serpentine mapping route.' },
  'planer.bahnabstand': { de: 'Bahnabstand', en: 'Line spacing' },
  'planer.richtungOstWest': { de: 'Ost-West', en: 'East-West' },
  'planer.richtungNordSued': { de: 'Nord-Süd', en: 'North-South' },
  'planer.rasterErzeugen': { de: 'Raster erzeugen', en: 'Generate grid' },
  'planer.eckenGesetzt': { de: 'Ecken gesetzt', en: 'corners set' },
  'planer.rasterBegrenzt': { de: 'Sehr feiner Bahnabstand — die Bahnenzahl wurde begrenzt, der Abstand also etwas vergrößert.', en: 'Very fine spacing — the number of lines was capped, so the spacing was widened a little.' },
  'planer.fussnote': {
